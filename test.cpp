...
/*
  ...
  ==============================
*/
void G_ResourceTypeRegister( g_resources_t *rp, char *type_name, 
...
/*
  ...
  ==============================
*/
void G_ResourceFromClass( g_resources_t *res, char *name )
{
	tokenstream_t	*ts;
	hobj_t		*root;
	hobj_t		*resobj;
...
/*
  ...
  ==============================
*/
g_resource_t * G_ResourceSearch( g_resources_t *res, char *name )
{
	g_resource_t	*r;
	g_res_type_t	*rt;
...
void G_ResourceDetach( g_resources_t *res, char *name, char *user_name )
{
	...
	//
	U_ListIterInit( &iter, r->user_list );
	for ( ; ( ru = (g_re)U_ListIterNext( &iter ) ) ; )
	{
		if ( !strcmp( ru->user_name, user_name ) )
		{
